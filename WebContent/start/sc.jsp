...
$(document).ready(function(){
  ...
  reset.click(function(){
	...
	G1.click(function(){map_move();	var timer=setInterval(function() {
		location.href = "G1.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);  });
	A1.click(function(){map_move();	var timer=setInterval(function() {
		 location.href = "A1.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	A3.click(function(){map_move();	var timer=setInterval(function() {
			 location.href = "A3.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
		  	  clearInterval(timer);    }, 1000);	});
	A4.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "A4.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	B2.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "B2.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	B3.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "B3.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	B5.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "B5.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	B6.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "B6.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	B8.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "B8.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	C1.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "C1.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	C2.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "C2.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	C6.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "C6.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	C7.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "C7.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	D1.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "D1.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	D3.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "D3.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	D5.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "D5.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	E2.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "E2.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	E3.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "E3.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	E5.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "E5.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	E7.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "E7.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	F4.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "F4.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	F8.click(function(){map_move();var timer=setInterval(function() {
		 location.href = "F8.jsp?id=<%=bean.getId()%>&ch=<%=bean.getCh()%>&now="+now;
	  	  clearInterval(timer);    }, 1000);	});
	...
	function cancel_map(){
	  ...
	  function find_fun(){
		  ...
		  search.fadeOut(0);
		  find_can=0;
		  mbg.animate({ top : "30px",height:"110%",width:"110%",left:"-50px",opacity:"0.8" },550)
	      .animate({ top : "10px",height:"120%",width:"120%",left:"-100px",opacity:"0.6"  },300)
	      .animate({ top : "30px",height:"130%",width:"130%",left:"-150px",opacity:"0.1"  },550)
	      .animate({ top : "10px",height:"100%",width:"100%",left:"10px"  },0);
		  
		  var timer=setInterval(function() {
			  var audio = new Audio('../../audio/아이템_획득.wav');
			  audio.play();
	  ...
	  $('body').keydown(function(e){
		  //alert(e.keyCode);
		   if(e.keyCode==70&&find_can==2&&can==0){
			find_fun();			   
		   }
		   else if(e.keyCode==27&&find_can==1&&can==1){
			   cancel_item_get();
		   }
		   else if(e.keyCode==27&&can==2){
			   cancel_map();
		   }
		   else if(e.keyCode==81&&move_can==0&&can==0){
			   mov();
		   }
	  });
